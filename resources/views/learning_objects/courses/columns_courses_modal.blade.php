            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div>
                    <div class="checkbox_columns_selector content-container mt-1 flex gap-2 flex-col">
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_status_name" name="column_status_name" value="status_name" checked
                                class="mr-[11px] w-[22px] h-[22px]">
                            <label for="column_status_name">Estado</label>
                        </div>

                        <div class="flex">
                            <input type="checkbox" id="column_realization_start_date" name="column_realization_start_date"
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_realization_finish_date" name="column_realization_finish_date"
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_educational_programs_name" name="column_educational_programs_name"
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_centers_name" name="column_centers_name" value="centers_name"
                                class="mr-[11px] w-[22px] h-[22px]">
                            <label for="column_centers_name">Centro</label>
                        </div>

                        <div class="flex">
                            <input type="checkbox" id="column_inscription_start_date" name="column_inscription_start_date"
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_inscription_finish_date" name="column_inscription_finish_date"
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_enrolling_start_date" name="column_enrolling_start_date"
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_enrolling_finish_date" name="column_enrolling_finish_date"
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_presentation_video_url" name="column_presentation_video_url"
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_ects_workload" name="column_ects_workload" value="ects_workload"
                                class="mr-[11px] w-[22px] h-[22px]">
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_contact_emails" name="column_contact_emails" value="contact_emails"
                                class="mr-[11px] w-[22px] h-[22px]">
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_teachers_no_coordinate" name="column_teachers_no_coordinate"
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_categories" name="column_categories" value="categories"
                                class="mr-[11px] w-[22px] h-[22px]">
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_featured_big_carousel" name="column_featured_big_carousel"
                        ...
                        <div class="flex">
                            <input type="checkbox" id="column_featured_small_carousel" name="column_featured_small_carousel"
