...
<body>
    ...
    <a href="{{ $parameters['url'] }}" style="background-color:#2C4C7E; color: white; padding: 10px 20px; text-decoration: none; margin-top: 20px; margin-bottom: 20px;">Restablecer contraseña</a>
